param(
    ...
    [array] $Patches = @(
        @{
            PatchFile = "${PSScriptRoot}/patches/0001-fix-vista-style-clobbering-stylesheets.diff"
            HashSum = "c2cc0c114c09eb29d0a57b0adbd3ab4a2a1204fe92bc1e75e1e2e94e3e037fb7"
        }
    )
)
